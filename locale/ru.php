...
Sprint\Editor\Locale::loadLocale(array(
    ...
    "SPRINT_EDITOR_LOAD_JQUERY" => "Подключить jquery",
    "SPRINT_EDITOR_LOAD_JQUERY_UI" => "Подключить jquery ui",
    "SPRINT_EDITOR_LOAD_DOTJS" => "Подключить шаблонизатор doT",
    "SPRINT_EDITOR_SHOW_SORT_BUTTONS" => "Показывать кнопки сортировки",
    ...
    "SPRINT_EDITOR_SELECT_EMPTY" => "Добавление блоков отключено",
