sprint_editor.registerBlock('my_image', function ($, $el, data) {
    ...
    this.afterRender = function () {
        ...
        $btninput.fileupload({
            dropZone: $el,
            url: sprint_editor.getBlockWebPath('my_image') + '/upload.php',
            dataType: 'json',
        ...
        $el.find('.sp-download-url').bindWithDelay('input', function () {
            ...
            $.ajax({
                url: sprint_editor.getBlockWebPath('my_image') + '/download.php',
                type: 'post',
                data: {
                    url: urlvalue
                },
    ...
    var renderfiles = function () {
        $el.find('.sp-result').html(
            sprint_editor.renderTemplate('my_image-image', data)
        );
    };
